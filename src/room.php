                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <label for="">ឈ្មោះបន្ទប់</label>
                                                <input type="text" name="names" class="form-control" value="<?php echo $row['names']; ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="">ចំនួនតុ</label>
                                                <input type="text" name="table" class="form-control" value="<?php echo $row['table']; ?>">
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" name="updateroom" class="btn btn-primary">រក្សាទុក</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="./crud/delete.php?deleteroom=<?php echo $row['id']; ?>" class="btn btn-danger">លុបទិន្ន័យ</a>
                    ...
                    <form action="./crud/insert.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="names">ឈ្មោះបន្ទប់</label>
                                        <input type="text" id="names" name="names" class="form-control" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="detail">ចំនួនតុ</label>
                                        <input type="text" id="table" name="table" class="form-control" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" name="saveroom" class="btn btn-primary">រក្សាទុក</button>
                                </div>
                            </div>
                        </div>
                    </form>
